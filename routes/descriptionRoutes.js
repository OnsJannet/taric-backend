...
router.post("/get-suggested-materials", async (req, res) => {
  try {
    ...
    Given the product description, provide all possible materials associated with the product in ${
      language === "it" ? "Italian" : "English"
    }.
    
    - Translate materials to ${language === "it" ? "Italian" : "English"} where appropriate.
    - Include all possible materials that could be associated with the product, based on its description.
